...
#             # If a user message is immediately followed by an assistant message, group them.
...
#                 # Render assistant message with inline action buttons
...
#                     # Save Note button appears only under AI responses
...
#                     else:
#                         cols[0].empty()
#                     # Rerun button now shows a spinner
